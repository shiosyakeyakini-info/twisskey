...
import 'package:twisskey/color_schemes.g.dart';
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return AlertDialog(
                                                                            title:
                                                                                const Text("再リツイート警告"),
                                                                            content:
                                                                                const Text("このツイートはすでにリツイート済みです。再リツイートしますか？(この警告は将来的に設定で無効化できます)"),
                                                                            actions: <Widget>[
                                                                              GestureDetector(
                                                                                child: Container(
  ...
  Widget checkImageOrText(text, image) {
    ...
    if (text != null) {
        ...
        return Column(
          ...
          children: [
            Mfm(
              ...
              linkStyle: TextStyle(color: darkColorScheme.primary),
              mentionStyle: TextStyle(color: Theme.of(context).primaryColor),
              emojiBuilder: (context, emoji, style) {
                final emojiData = emojiList[emoji];
                if (emojiData == null) {
      ...
      return Mfm(
        ...
        mentionStyle: TextStyle(color: Theme.of(context).primaryColor),
        hashtagStyle: TextStyle(color: Theme.of(context).primaryColor),
        emojiBuilder: (context, emoji, style) {
          final emojiData = emojiList[emoji];
          if (emojiData == null) {
            return Text.rich(TextSpan(text: emoji, style: style));
